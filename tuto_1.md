...
Ajoute le bloc ``||scroller:scroll background with ||`` sous le bloc ``||variables:définir mySprite ||``.
...
Remplace la valeur de vx par ``||scroller:-10 ||``.

Remplace la valeur de vy par ``||scroller:0 ||``.
